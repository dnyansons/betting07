...
<html lang="en">
    ...
    <body>
        ...
        <div class="ibox login-content">
            ...
            <form class="ibox-body pt-0" id="forgot-form" action="<?php echo base_url(); ?>auth/forget_password/reset_password/token/<?php echo $token; ?>" method="POST">
                <h4 class="font-strong text-center mb-4">UPDATE PASSWORD</h4>
                ...
                <div class="form-group mb-4">
                    <input class="form-control form-control-line" type="password" name="passconf" placeholder="Confirm Password">
                    <?php echo form_error("passconf"); ?>
                </div>
                <div class="text-center">
                    <button class="btn btn-primary btn-rounded btn-block btn-air">Update</button>
                </div>
            </form>
        </div>
