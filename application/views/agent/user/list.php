<div class="page-heading">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">My Users</li>
    </ol>
    <a href="<?php echo base_url(); ?>agent/users/add" class="on-up btn btn-gradient-blue btn-icon-only btn-circle btn-lg btn-air pull-right"><i class="ti-plus"></i></a>
</div>
...
<script>
    $(document).ready(function () {
        $('#datatable').DataTable({
            ...
            //dom: 'Bfrtip',
            ajax: {
                url: "<?php echo base_url('agent/users/ajax_list'); ?>",
                dataType: "json",
                type: "POST",
...
<script>
    function change_status(user_id)
    {
        if (user_id != '') {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>agent/users/check_user_status',
                method: 'POST',
