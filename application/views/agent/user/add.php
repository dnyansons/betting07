...
<script>
    function get_state(id)
    {
        if (id != '') {
            $.ajax({
                url: '<?php echo base_url(); ?>agent/users/get_state',
                method: 'POST',
                data: {country_id: id},
    ...
    function check_username_exist(uname)
    {
        if (uname != '' && uname.length >= 4) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>agent/users/check_username_exist',
                method: 'POST',
                data: {uname: uname},
                success: function (data) {
                    console.log(data);
    ...
    function check_mobile_exist(mobile)
    {
        if (mobile != '' && mobile.length > 8) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>agent/users/check_mobile_exist',
                method: 'POST',
                data: {mobile: mobile},
                success: function (data) {
                    console.log(data);
    ...
    function check_email_exist(email)
    {
        if (email != '') {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>agent/users/check_email_exist',
                method: 'POST',
                data: {email: email},
                success: function (data) {
                    console.log(data);
