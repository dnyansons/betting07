        ...
        <div class="page-wrapper">
            ...
            <header class="header">
                <div class="page-brand">
                    <a href="<?php echo base_url(); ?>agent/agent_dashboard">
                        <span class="brand">Betting 07</span>
                        ...
                        <li class="dropdown dropdown-inbox">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-media">
                                ...
                                <div class="dropdown-header text-center">
                                    ...
                                    <a class="text-muted font-13" href="<?php echo base_url(); ?>agent/notification">view all</a>
                                </div>
                                <div class="p-3">
                                        ...
                                        foreach ($noti as $noti_dat) {
                                            ...
                                            <a class="media p-3">
                                                ...
                                                <div class="media-body">
                                                    <div class="media-heading"><?php echo $noti_dat->title; ?><small class="text-muted float-right"><?php echo date('d M', strtotime('created_at')); ?></small></div>
                        ...
                        <li class="dropdown dropdown-user">
                            ...
                            <div class="dropdown-menu dropdown-arrow dropdown-menu-right admin-dropdown-menu">
                                ...
                                <div class="admin-menu-features">
                                    ...
                                    <a class="admin-features-item" data-toggle="modal" data-target="#profile_model" href="javascript:;"><i class="ti-user"></i>
                                        <span>PROFILE</span>
                                    </a>
                                ...
                                <div class="admin-menu-content">
                                    ...
                                    <div class="d-flex justify-content-between mt-2">
                                        ...
                                        <a onclick="return confirm('Are You Sure ? ');" class="d-flex align-items-center" href="<?php echo base_url(); ?>admin-logout">Logout&nbsp;&nbsp;&nbsp;<i class="fa fa-sign-out" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
                        </li>
