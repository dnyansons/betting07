...
<div class="page-content fade-in-up">
    <div class="row mb-4">
        <div class="col-lg-3 col-md-6">
            <div class="card mb-3">
                <a href="<?php echo base_url('agent/users') ?>">
                    <div class="card-body flexbox-b">
                        ...
                        <div>
                            <h3 class="font-strong text-success"><?php echo $tot_users; ?></h3>
                            <div class="text-muted">MY USERS</div>
                        </div>
                    </div>
                </a>
            </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card mb-3">
                <a href="<?php echo base_url('agent/market/set_market') ?>">
                    <div class="card-body flexbox-b">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card mb-3">
                <a href="<?php echo base_url('agent/wallet') ?>">
                    <div class="card-body flexbox-b">
